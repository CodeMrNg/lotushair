...
urlpatterns = [
    ...
    path("membre/annonces/<int:announcement_id>/lu/", views.mark_announcement_read, name="mark_announcement_read"),
    ...
    path("gestion/annonces/", views.manage_announcements, name="manage_announcements"),
    path("gestion/annonces/<int:announcement_id>/modifier/", views.edit_announcement, name="edit_announcement"),
